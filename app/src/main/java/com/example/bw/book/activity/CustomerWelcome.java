...
import com.example.bw.book.adapter.ViewAllBooksAdapter;
...
public class CustomerWelcome extends AppCompatActivity {
    ...
    Button signOut, searchBooks, viewCart, titleAscending, titleDescending, authorAscending, authorDescending, priceAscending, priceDescending;
